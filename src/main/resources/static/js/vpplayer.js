...
(function($) {
	$.fn.vpplayer = function(options) {
		...
		return $(this).each(
				function() {
					...
					h.ev(h.c.raT1, "click", Rtc1);
					h.ev(h.c.raT2, "click", Rtc2);
					h.ev(h.c.raT3, "click", Rtc3);
					h.ev(h.c.raT4, "click", Rtc4);
				});
	};
	...
	function cP() {
		...
		h.c.pc = h.d("div", {
			a : "class",
			v : "track-picture-container d-none" //Mir
		},undefined,
		(h.playerColor != undefined)?(
				(h.playerColor.con(","))?(
		...
		// , {a : "playbackrate", v : h.playbackrate}
		h.c.asl = h.d("source",
		...
		*/
		...
		h.c.plnres = h.d("a", {
			a : "class",
			v : "download playerNameRes glyphicon_mir glyphicon-download-alt"
		},undefined,undefined);
		...
		h.c.rat1 = h.d("div", {
			a : "class",
			v : "playrate1x playerNameRes"
		},undefined,undefined);

		h.c.rat2 = h.d("div", {
			a : "class",
			v : "playrate12x playerNameRes"
		},undefined,undefined);

		h.c.rat3 = h.d("div", {
			a : "class",
			v : "playrate14x playerNameRes"
		},undefined,undefined);

		h.c.rat4 = h.d("div", {
			a : "class",
			v : "playrate18x playerNameRes"
		},undefined,undefined);
		...
		h.c.rat1.appendChild(h.c.raT1);
		h.c.rat2.appendChild(h.c.raT2);
		h.c.rat3.appendChild(h.c.raT3);
		h.c.rat4.appendChild(h.c.raT4);
		...
		h.c.tcec.appendChild(h.c.rat4);
		h.c.tcec.appendChild(h.c.rat3);
		h.c.tcec.appendChild(h.c.rat2);
		h.c.tcec.appendChild(h.c.rat1);
		...
		var interval = setInterval(
				function() {
						...
						if(!isNaN(h.c.a.duration)){
							h.ct(h.c.stt, sm(h.c.a.currentTime) + '  ('+h.c.a.playbackRate+'x)');
	...
	var Rtc1 = function(e) {
		h.c.a.playbackRate = 1.0;
	};
	var Rtc2 = function(e) {
		h.c.a.playbackRate = 1.2;
	};
	var Rtc3 = function(e) {
		h.c.a.playbackRate = 1.4;
	};
	var Rtc4 = function(e) {
		h.c.a.playbackRate = 1.8;
	};
